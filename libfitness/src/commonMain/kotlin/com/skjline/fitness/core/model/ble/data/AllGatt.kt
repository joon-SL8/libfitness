...
object AllGattServices : AllGatt {
    override val attributes =  hashMapOf(
...
object AllGattDescriptors : AllGatt {
    override val attributes = hashMapOf(
...
object AllGattCharacteristics : AllGatt {
    override val attributes = hashMapOf(
        "00002a00-0000-1000-8000-00805f9b34fb" to "Device Name",
        "00002a01-0000-1000-8000-00805f9b34fb" to "Appearance",
        "00002a02-0000-1000-8000-00805f9b34fb" to "Peripheral Privacy Flag",
        ...
        "00002a93-0000-1000-8000-00805f9b34fb" to "Sport Type for Aerobic and Anaerobic Thresholds",
